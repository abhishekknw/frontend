...
function LeadDetailModal() {
  ...
  return (
    <>
      ...
      <Modal show={showHideModal.leadDetail.show} onHide={handleClose} className='wpModal lead-modal'>
          ...
          <div className='row'>
            <div className='col-md-6'>
              ...
              <div>
                ...
                <p>test adddress Prayagraj, Uttar Pradesh 211011,Prayagraj, Allahabad,Uttar Pradesh,India, 110002,(18.222,72.0)</p>
              </div>
