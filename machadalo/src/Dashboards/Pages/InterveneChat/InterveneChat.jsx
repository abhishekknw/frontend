                    ...
                    <li className="w-100">
                      ...
                      <ul className="d-flex justify-content-between">
                        <li>
                          ...
                          <h4 className="user-typing-text pt-0">Chat Person Name</h4>
                        </li>
                        <li>
                          <p className="con-icons">
                            <span>
                              <BsCameraVideo />
                            </span>{' '}
                            <span>
                    ...
                    <li className="chat-box active-chat">
                      <ul className="d-flex">
                        ...
                        <li className="w-100">
                          ...
                          <ul className="d-flex justify-content-between">
                            <li>
                              <h4 className="user-name">Chat Person</h4>
                            </li>
                            <li>
                              <p className="chat-time">09:11 PM</p>
                            </li>
                          </ul>
                          <ul className="d-flex justify-content-between">
                            <li>
                              <h4 className="user-typing-text">Chat Person Name</h4>
                            </li>
                            <li>
                              <p className="chat-count">02</p>
                            </li>
                          </ul>
                          {/* inner chat heading and content end */}
                        </li>
