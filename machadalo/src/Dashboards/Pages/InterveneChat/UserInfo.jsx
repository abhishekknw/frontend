...
import { AddUpdateSupplierModal } from './AddUpdateSupplierModal';
          ...
          <div className="user-profile-according">
            <Accordion>
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  <div className="user-profile-inner">
                    <p>
                      Session ID: <span>sdv1sd1v54564</span>
                    </p>
                    <p>
                      User Type: <span>registered</span>
                    </p>
                    <p>
                      Created at: <span>Sep 28, 2021 2:53:39 PM</span>
                    </p>
                    <p>
                      Last Active: <span>Sep 11, 2023 3:23:44 AM</span>
                    </p>
                  </div>
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey="1">
                ...
                <Accordion.Body>No Template Message Send</Accordion.Body>
              </Accordion.Item>
