...
import { BsFilePersonFill, BsFillBuildingsFill, BsFillPersonVcardFill } from 'react-icons/bs';
    ...
    <>
      ...
      <div className="bg-color">
        <Container className="pt-4 lead-first-container">
          <Tabs defaultActiveKey={TabKey} id="main-tab" className="mb-3 top-main-tab" fill>
            <Tab eventKey="lead" title="Leads">
            <Button variant="primary" onClick={(e)=>{setLayers({ firstLayer: true, secondLayer: false ,thirdLayer: false})}}>Back</Button>{' '}
              <div className="pt-4">
                ...
                <div className="pt-2">
                  { layers.firstLayer &&
                    <Row className="pt-5 ">
                      <Col sm={3} onClick={(e)=>{setLayers({...layers,firstLayer: false, secondLayer: true})}}>
                  ...
                  <Row className="p-5 text-center city-row ms-1 me-1">
                    <Col sm={4} onClick={(e)=>{setLayers({...layers, secondLayer: true,thirdLayer: true})}}>
                      <div className="d-flex lead-box-first">
                        <div class="me-3">
                          <span class="db-image-icon">
                            <BsFilePersonFill />
            ...
            <Tab eventKey="pay" title="Payment & Licsence" onSelect={(k) => setKey(k)}>
