...
export default function BasicDetails() {
  ...
  const getDetails = () => {
    fetchWrapper.get(ANG_APIS.GET_LIST_GENERIC + id + `/?supplier_type_code=CO`).then((res) => {
      setDetails(res.data);
    });
  };
      ...
      <div className="tabContentBox">
        ...
        <form role="form" name="hording_form" ng-submit="updateDetails()">
          <div className="contentBox">
            <div className="item">
              <label for="supplier_id">Corporates ID</label>
              <input
                type="text"
            ...
            <div className="item">
              <label for="eyeball_count ">Weekday Listnership Count</label>
              <input
                type="text"
            ...
            <div className="item">
              <label for="traffic_count ">Weekend Listnership Count</label>
              <input
                type="text"
            ...
            <div className="item">
              <label for="pedestrian_count ">Average Listnership Time</label>
              <input
                type="text"
            ...
            <div className="item">
              <label>Name of Corporates</label>
              <br />
              <input
                type="text"
                className="form-control"
                ng-model="ownership_details.bank_account_name"
                placeholder="Name of Corporates"
              />
            </div>
            <div className="item">
