...
export default function BasicDetailsEducationInstitute() {
  const { id } = useParams();
  ...
  const getDetails = () => {
    fetchWrapper.get(ANG_APIS.GET_LIST_GENERIC + id + `/?supplier_type_code=EI`).then((res) => {
      setDetails(res.data);
    });
  };
      ...
      <div className="tabContentBox">
        ...
        <form role="form" name="hording_form" ng-submit="updateDetails()">
          <div className="contentBox">
            <div className="item">
              <label for="supplier_id">Education Institute ID</label>
              <input
                type="text"
                className="field"
                id="supplier_id"
            ...
            <div className="item">
              <label>Education Institute Type</label>
              <select className="field" value={details?.inst_type} ng-change="instSelect()">
                <option value="" disabled>
                  Select Education Institute Type{' '}
                </option>
                {/* <option ng-repeat="instType in educationInstType" value="{{instType}}">{{instType}}</option> */}
              </select>
            </div>
            <div className="item" ng-show="model.inst_type == 'Others'">
              <label for="longitude">Other Institute type</label>
              <input
                type="text"
                step="any"
                className="field"
                id="longitude"
                value={details?.inst_other_type}
              />
            </div>
            <div className="item">
              <label>Sub Type</label>
              <select className="field" value={details?.inst_sub_type}>
                <option value="" disabled>
                  Select Sub Type{' '}
                </option>
                {/* <option ng-repeat="instSubType in educationInstSubType" value="{{instSubType}}">{{instSubType}}</option> */}
              </select>
            </div>
            <div className="item" ng-show="model.inst_sub_type == 'Others'">
              <label for="longitude">Other Institute sub type</label>
              <input
                type="text"
                step="any"
                className="field"
                id="sub"
                value={details?.inst_sub_other_type}
              />
            </div>
            <div className="item">
              <label>Education Board</label>
              <select className="field" value={details?.educationBoard}>
                <option value="" disabled>
                  Select Education Board
                </option>
                {/* <option ng-repeat="edb in educationBoard" value="{{edb}}">{{edb}}</option> */}
              </select>
            </div>
            <div className="item" ng-show="model.educationBoard == 'Others'">
              <label for="longitude">Other Education Board</label>
              <input
                type="text"
                step="any"
                className="field"
                id="sub"
                value={details?.educationBoard_other}
              />
            </div>
            <div className="item">
            ...
            <div className="item">
              <label for="eyeball_count ">Total No. of Students</label>
              <input
                type="text"
            ...
            <div className="item">
              <label for="traffic_count ">Total No. of Teachers & Employees</label>
              <input
                type="text"
                placeholder="Total No. of Teachers & Employees"
                className="field"
                id="traffic_count"
            ...
            <div className="item">
              <label>Name of Education Institute</label>
              <br />
              <input
                type="text"
                className="form-control"
                ng-model="ownership_details.bank_account_name"
                placeholder="Name of education institute"
              />
            </div>
            <div className="item">
