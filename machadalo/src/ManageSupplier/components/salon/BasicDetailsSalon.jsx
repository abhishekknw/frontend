...
export default function BasicDetailsSalon() {
  const { id } = useParams();
  ...
  return (
    <>
      <div className="panel-default panel-container">
        ...
        <br />
        <form className="form-inline" role="form" name="Salon_form" ng-submit="updateDetails()">
          ...
          <div className="form-group col-md-3" style={{ marginBottom: '20px' }}>
            ...
            <select className="form-control" ng-model="model.Salon_type" required>
              <option value="" disabled>
                Select Salon Type
              </option>
              <option ng-repeat="Salon_type in Salontypelist" value="{{Salon_type}}">
                {/* {{ Salon_type }} */}
              </option>
            </select>
          </div>
          <div className="form-group col-md-3" style={{ marginBottom: '20px' }}>
            ...
            <br />
            <select className="form-control" ng-model="model.Salon_type_chain">
              <option value="" disabled>
