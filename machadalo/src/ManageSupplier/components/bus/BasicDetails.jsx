...
export default function BasicDetails() {
  ...
  const getDetails = () => {
    fetchWrapper.get(ANG_APIS.GET_LIST_GENERIC + id + `/?supplier_type_code=BU`).then((res) => {
      setDetails(res.data);
    });
  };
      ...
      <div className="tabContentBox">
        ...
        <form role="form" name="hording_form" ng-submit="updateDetails()">
          <div className="contentBox">
            <div className="item">
              <label for="supplier_id">Bus ID</label>
              <input
                type="text"
            ...
            <div className="item">
              <label for="eyeball_count ">Onboarded Count</label>
              <input
                type="text"
                placeholder="Onboarded Count"
                className="field"
                id="eyeball_count"
            ...
            <div className="item">
              <label for="traffic_count ">Average Onboarding Time</label>
              <input
                type="text"
                placeholder="Average Onboarding Time"
                className="field"
                id="traffic_count"
            ...
            <div className="item">
              <label for="traffic_count ">Distance Count</label>
              <input
                type="text"
