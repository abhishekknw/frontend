 ...
 .factory('mapViewService', ['machadaloHttp','$stateParams','$rootScope','$routeParams', '$location', '$http',
  function (machadaloHttp, $stateParams, $rootScope, $routeParams, $location, $http) {
    ...
    mapViewService.searchSuppliers = function(code,searchtext,vendorId,supplier_center,center_areas){
    ...
    mapViewService.getLocations = function (name) {
      var url = url_base_societyDetails + "getCityArea?search="+name ;
      return machadaloHttp.get(url);
  }
