  ...
  .controller('MapCtrl', function ($scope, $rootScope, $stateParams, $window, $location, createProposalService, mapViewService, $http, uiGmapGoogleMapApi, uiGmapIsReady, $q, Upload, $timeout, commonDataShare, constants, $filter, permissions) {
    ...
    uiGmapGoogleMapApi.then(function (maps) {
      ...
      function getIcon(supplier, key) {
        ...
        if (key == 'GY') {
          icon = icons[key] + "800080";
        }

        if (key == 'SA') {
          icon = icons[key] + "A52A2A";
        }
        if (key == 'RE') {
          icon = icons[key] + "0000FF";
        }

        if (key == 'RS') {
          icon = icons[key] + "FFFF00";
        }
      ...
      var icons = {
        ...
        'RS': 'http://www.googlemapsmarkers.com/v1/' + 'RS/',
        'CP': 'http://www.googlemapsmarkers.com/v1/' + 'CP/',
        'BS': 'http://www.googlemapsmarkers.com/v1/' + 'BS/',
        'GY': 'http://www.googlemapsmarkers.com/v1/' + 'GY/',
