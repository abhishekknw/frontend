...
(function () {
    ...
    angular.module('catalogueApp')
      .controller('interveneTemplateCtrl', function ($scope, $rootScope, AuthService, $stateParams) {
        $scope.userDetail = function (number, page) {
          ...
          $scope.userDetail($stateParams.phoneNumber);
      })})()

// angular.module('machadaloCommon')
// .directive('interveneTemplate', function($window,$rootScope,constants,$timeout, permissions) {
